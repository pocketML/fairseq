...
def inspect(
    ...
    try:
        ...
        model.predict('sentence_classification_head', input, return_logits=True)
    else: ()
    finally:
...
def summary(
    ...
    print(f'input_size: {input_size}, dtype: {input_dtype}, input_initializer: {input_initializer}, batch_size: {batch_size}')
    summary = inspect(
        model,
        input_size,
